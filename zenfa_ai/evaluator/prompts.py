...
**CRITICAL: You MUST use your Google Search grounding tool to find recent community data \
(Reddit threads, YouTube reviews, tech forum posts) when evaluating components.** \
Specifically search for: known hardware issues (thermals, driver problems, DOA rates) and recent sentiment.
